...
import { MappingTest, bookingCreate, bookingEdit, bookingFetch, bookingRemove, bookings, web3 } from "../contractFunctions";
export const Admin = () => {
  ...
  /*     const restaurantCreate = async () => { 
      ...
      bookingEdit(account, "0", "x", "1", "2", "17");
      }
  ...
  return (<>
    ...
    <button value="bookingFetch" onClick={bookingEditTest}>Edit booking</button>
    </section>
